...
public class CompoundButton extends android.widget.CompoundButton implements IAutoFit {
    ...
    public void setTextSize(float size) {
        setTextSize(0, ScreenParameter.getFitSize(this, size));
    }

    @Override
    public float getTextSize() {
        return super.getTextSize() / ScreenParameter.getRatioX(getContext());
    }
    ...
    public void setMinimumHeight(int minHeight) {
        super.setMinimumHeight(ScreenParameter.getFitSize(this, minHeight));
    }
