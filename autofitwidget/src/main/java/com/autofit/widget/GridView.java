...
public class GridView extends android.widget.GridView implements IAutoFit {
    ...
    public void setVerticalSpacing(int verticalSpacing) {
        super.setVerticalSpacing(ScreenParameter.getFitHeight(this, verticalSpacing));
    }

    @Override
    public void setHorizontalSpacing(int horizontalSpacing) {
        super.setHorizontalSpacing(ScreenParameter.getFitWidth(this, horizontalSpacing));
    }
}
