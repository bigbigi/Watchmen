...
public class ExpandabListView extends ExpandableListView implements IAutoFit {
    ...
    public ExpandabListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initAutoView(context, attrs);
    }

    public ExpandabListView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        initAutoView(context, attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public ExpandabListView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void setDividerHeight(int height) {
        super.setDividerHeight(ScreenParameter.getFitHeight(this, height));
    }
